...
#data = pd.read_csv("poetry_data.csv")
data = data[['Hindi Poetry', 'English Poetry']].dropna()
...
# Save model
model.save("seq2seq_poetry_translation.h5")
...
reverse_target_word_index[0] = ''  # for padding
...
if __name__ == "__main__":
    test_hindi = "तारों की छाँव में रातें बिताते हैं"
    print("Hindi:", test_hindi)
    print("English Translation:", translate_line(test_hindi))
